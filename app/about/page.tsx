  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-7 pt-24 pb-16">
        {/* Eyebrow */}
        <div className="font-mono text-[11px] text-primary tracking-[0.12em] mb-10 flex items-center">
          <span className="text-primary">¶</span>
          <span className="font-serif italic mx-2.5">vii.</span>
          <span className="text-[rgba(0,0,0,0.1)] dark:text-[rgba(255,255,255,0.06)]">
            —
          </span>
          <span className="mx-2.5">{t("nosotros", "about")}</span>
          <span className="ml-auto text-muted">
            {t(
              "el estudio detrás de los envíos",
              "the studio behind the shipments",
            )}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-16 items-start">
          <div>
            <h1 className="font-serif text-[clamp(40px,8vw,60px)] leading-[0.99] tracking-[-0.02em] font-normal text-primary mb-10">
              {t("Dos disciplinas.", "Two disciplines.")}
              <br />
              <span className="italic text-secondary/80">
                {t("Un estudio.", "One studio.")}
              </span>
              <br />
              {t("Cada proyecto", "Every project")}{" "}
      ...
      {/* Principles */}
      <section className="py-16 px-6 md:px-10 border-t border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.06)] bg-primary/20">
        <div className="max-w-[1400px] mx-auto">
          ...
          <h2 className="font-serif text-[40px] leading-[1.02] tracking-[-0.02em] font-normal text-foregorund max-w-[480px] mb-14">
            {t("Cómo", "How we")}{" "}
      ...
      {/* How we work */}
      <section className="py-16 px-6 md:px-10 border-t border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.06)] bg-bg">
        <div className="max-w-[1400px] mx-auto">
          <div className="font-mono text-[11px] text-primary tracking-[0.12em] mb-10 flex items-center">
            <span className="text-primary">¶</span>
          ...
          <ol className="flex flex-col max-w-2xl">
            {howWeWork.map((step, i) => (
              ...
              >
                <span className="font-mono text-[11px] text-foreground tracking-[0.12em] pt-1 shrink-0">
          ...
          <div className="mt-10">
            <Link
              href="/contact"
              className="text-[12px] text-primary tracking-[0.04em] border-b border-muted pb-0.5 hover:border-primary transition-colors"
            >
      ...
      {/* Partnership */}
      <section className="py-16 px-6 md:px-10 border-t border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.06)] bg-secondary/30">
        <div className="max-w-[1400px] mx-auto">
          <div className="font-mono text-[11px] text-secondary tracking-[0.12em] mb-10 flex items-center">
            <span className="">¶</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 items-start">
            <div>
              <h2 className="font-serif text-[40px] leading-[1.02] tracking-[-0.02em] font-normal text-[#1A1A1A] dark:text-[#F5F5F7] max-w-[480px] mb-6">
                {t(
                  "Alcance extendido cuando el proyecto",
                  "Extended reach when the project",
                )}{" "}
                <span className="italic text-secondary">
                  {t("lo necesita.", "calls for it.")}
                </span>
              </h2>
              <p className="text-[14px] text-foreground leading-[1.65] max-w-md mb-8">
                {t(
                ...
                <a
                  ...
                  className="text-secondary transition-colors underline underline-offset-4"
                >
                  The Wave Estudio
                </a>
                {t(
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[12px] text-secondary tracking-[0.04em] border-b border-secondary/60 pb-0.5 hover:border-secondary transition-colors"
              >
                {t("Visitar The Wave Estudio", "Visit The Wave Estudio")}{" "}
                &nbsp;&rarr;
              </a>
            </div>
      ...
      {/* CTA */}
      <section className="py-24 px-6 md:px-10 border-t border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.06)] bg-background">
        <div className="max-w-[1400px] mx-auto text-center">
          <h2 className="font-serif text-[clamp(36px,7vw,54px)] leading-none tracking-[-0.02em] font-normal text-foreground mb-5">
            {t("Listo para", "Ready to")}{" "}
            <span className="italic text-secondary">
              {t("construir?", "build?")}
            </span>
          </h2>
          ...
          <Link
            href="/contact"
            className="cta-hover inline-block bg-secondary px-8 py-4 rounded-full text-[14px] font-medium text-background"
          >
            {t("Iniciar proyecto", "Start a project")} &nbsp;&rarr;
          </Link>
        </div>
