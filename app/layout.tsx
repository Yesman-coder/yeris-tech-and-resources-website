...
import { ModeSync } from "@/components/mode-sync";
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Yeris Tech & Resources — Product Studio",
    description: "Diseñamos lo complejo, para que experimentes lo simple.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${GeistSans.variable} ${GeistMono.variable} h-full antialiased bg-background terminal-scrollbar`}
