...
function ContactContent() {
  ...
  return (
    <section className="max-w-[1100px] mx-auto px-6 md:px-10 lg:px-16 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-16">
        <div>
          <Kicker className="mb-4 text-muted">
            {t("Contacto", "Get in touch")}
          </Kicker>
          ...
          <p className="text-base text-muted leading-relaxed mb-12 max-w-lg">
            {fromEstimator
              ? t(
        ...
        <aside className="flex flex-col gap-8 lg:pt-24">
          ...
          <div>
            ...
            <p className="text-base text-muted-foreground">
              {t(
                "Caracas, Venezuela · Trabajamos con clientes en todo el mundo",
          ...
          <div>
            <Kicker className="mb-2">
              {t("Tiempo de respuesta", "Response time")}
            </Kicker>
            <p className="text-base text-muted-foreground">
              {t(
                "En un día hábil — usualmente el mismo día.",
