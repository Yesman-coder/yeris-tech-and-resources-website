  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <SelectTrigger id="budget" aria-invalid={!!errors.budget}>
              <SelectValue
                placeholder={t("Seleccionar rango", "Select a range")}
            ...
            <SelectContent>
              ...
              <SelectItem value="Not sure yet">
                {t("No estoy seguro", "Not sure yet")}
              </SelectItem>
            </SelectContent>
          </Select>
          {errors.budget && (
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <SelectTrigger id="projectType" aria-invalid={!!errors.projectType}>
              <SelectValue placeholder={t("Seleccionar tipo", "Select type")} />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Textarea
          ...
          placeholder={t(
            ...
            "What are you building? What's your timeline? Any details help.",
          )}
          {...register("message")}
      ...
      <Button
        ...
        className="w-full md:self-start hover:opacity-90 transition-opacity font-medium text-base px-8 py-4 h-auto rounded-2xl"
      >
